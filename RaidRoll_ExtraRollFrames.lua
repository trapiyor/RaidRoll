...
-- FRAME NOT LOADED MESSAGE
 ...
 RR_RollFrame:SetScript("OnShow", function()
  ...
  if RaidRoll_DBPC[UnitName("player")]["RR_ExtraWidth"] == nil then RaidRoll_DBPC[UnitName("player")]["RR_ExtraWidth"] = 0 end
	...
	Raid_Roll_Name_String:SetText("DKP & Roll P.D. Capuli")
...
--------------------------------------------------------------
	...
	local RR_RollFrame_backdrop = {
	  ...
	  bgFile = "Interface\\Addons\\RaidRoll\\Images\\Lich_King",  -- path to the background texture
...
-- DKP button
--	RR_Roll_DkpButton = CreateFrame("Button", "RR_Roll_DkpButton", RR_RollFrame, "UIPanelButtonTemplate")
--	RR_Roll_DkpButton:SetWidth(20)
--	RR_Roll_DkpButton:SetHeight(20)
--	RR_Roll_DkpButton:SetPoint("BottomRight", RR_RollFrame, "Bottom", -120,10)
--	RR_Roll_DkpButton:SetText("+1 DKP")
--	RR_Roll_DkpButton:SetScript("OnClick",function() RandomRoll(1,100); end)
--	RR_Roll_DkpButton:SetScript("OnEnter",function(self) RR_MouseOverTooltip(self:GetName())	end)
--	RR_Roll_DkpButton:SetScript("OnLeave", function() GameTooltip:Hide()	end)
